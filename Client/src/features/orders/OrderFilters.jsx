      ...
      <section className="sticky top-18 z-40 mb-6">
        <div className="bg-surface-container/80 backdrop-blur-md rounded-xl p-3 tactile-shadow border border-[#e6e2db]/50 flex flex-wrap items-center gap-6">
          <div className="flex flex-col gap-1 min-w-60">
            <label className="text-[10px] uppercase tracking-wider font-bold text-outline px-1">
              Status
            </label>
          ...
          <div className="flex items-end h-full">
            <button className="flex items-center gap-1 px-6 py-2 text-brand-cedar text-[14px]  font-bold hover:bg-on-primary-fixed/30 rounded-lg transition-colors h-10 mt-5"
